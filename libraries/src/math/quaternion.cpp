...
mat4 Quaternion::m4() const
{
	...
	mat4 mq;
	mq.r[0] = { 2.f * (q0 * q0 + q1 * q1) - 1, 2.f * (q1 * q2 - q0 * q3), 2.f * (q1 * q3 + q0 * q2), 0.f };
	mq.r[1] = { 2.f * (q1 * q2 + q0 * q3), 2.f * (q0 * q0 + q2 * q2) - 1, 2.f * (q2 * q3 - q0 * q1), 0.f };
	mq.r[2] = { 2.f * (q1 * q3 - q0 * q2), 2.f * (q2 * q3 + q0 * q1), 2.f * (q0 * q0 + q3 * q3) - 1, 0.f };
	mq.r[3] = { 0.f, 0.f, 0.f, 1.f };
	return mq;
}
